...
@Composable
fun AuthenticatorAppVerification(navController: NavHostController, loginViewModel: LoginViewModel){
    Box(modifier = Modifier.fillMaxSize()){
        ScaffoldAuthenticatorAppVerification(navController, loginViewModel)
    }
}

@SuppressLint("UnusedMaterialScaffoldPaddingParameter")
@Composable
fun ScaffoldAuthenticatorAppVerification(navController: NavHostController, loginViewModel: LoginViewModel){
